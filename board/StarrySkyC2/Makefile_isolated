...
# find包含目录
INCLUDE_DIRS := Startup Library User System Hardware # Hardware需要等devices调整好api后再加入编译目录
...
# 链接脚本路径
LDS_PATH := $(shell find $(INCLUDE_DIRS) -type f -name "sections.lds")
